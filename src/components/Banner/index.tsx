...
export default function Banner() {
    return (
        <Flex w='100%' h={['163px', '250px', '250px', '335px']} bgImage="url('/banner.jpg')" bgPosition={['100% 20%', '100 20%', '100% 30%']} bgRepeat='no-repeat' bgSize='cover' >
            <Flex justify={['center', 'space-between']} align='center' w='100%' mx='auto' px={['4', '10', '15', '20', '36']}>
                <div>
                    ...
                    <Text color='gray.300' mt='5' fontSize={['0.8rem', 'xl']} maxW={['100%', '100%', '100%', '550px']}>
                        Chegou a hora de tirar do papael a viagem que você sempre sonhou.
                    </Text>
                </div>
                <Image
